...
usernames = ["tanergenek"]
# usernames = ["tuncaytursucu", "tanergenek", "arifcoskun05", "leventagan", "kadirturokozdmr"]

# headers kismini kendiniz uye olduktan sonraki key ve host bilgileriyle degistirin
headers = {
	"X-RapidAPI-Key": "d94c64475emsh5ea9c506a360f26p1af6b1jsnf8ca06575741",
...
def get_all_user_tweets(user_id, author):
    cursor = None
    result = []
...
df.to_csv(f"{usernames[0]}.csv", index=False)
